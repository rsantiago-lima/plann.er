...
export const CreateActivityModal = ({
  ...
  async function creacteActivity(event: FormEvent<HTMLFormElement>) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
      <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
        ...
        <form onSubmit={creacteActivity} className="space-y-3">
          ...
          <div className="h-14 flex-1 px-4 bg-zinc-950 border-zinc-900 rounded-lg flex items-center gap-2">
